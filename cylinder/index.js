...
function fillMissingValues(obj) {
    ...
    if (!obj.cylinderDimensions) obj.cylinderDimensions = {};
    obj.cylinderDimensions.diameter ??= getRandomNumber(5, 50);
    obj.cylinderDimensions.height ??= getRandomNumber(10, 100);
